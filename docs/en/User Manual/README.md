# Controller OPCB-221. Operating Manual.
...
| Name                                                                                         | Quantity (pcs.) |
| -------------------------------------------------------------------------------------------- | --------------- |
| Controller OPCB-221 (with installed MicroSD memory card and integrated Wi-Fi antenna, 3 dbm) | 1               |
| USB/RS-485 extension module (supporting up to 32 connected RS-485 devices)                   | 1               |
| Power supply with USB Type-A output and USB Type-C cable                                     | 1               |
| Ethernet cable                                                                               | 1               |
| Operation manual                                                                             | 1               |
...
1. **"PWR"** connector - USB Type-C for connecting a 5 V DC power source with a
   power of at least 9 W.
2. **"HDMI"** connector - HDMI output (not used).
3. **"AUX"** connector - Audio output (not used).
4. **"ETH"** connector - 8P8C/RJ45 for wired connection to the local network
   Ethernet;
5. **"EXT"** connectors - 4 USB Type-A connectors for connecting additional
...
| Overall dimensions HxBxL, mm, no more than                                                      | 95 х 60 х 30                           |
...
| Overall dimensions HxBxL, mm, no more than | ???           |
| Galvanic insulation, kV                    | ???           |
...
When connecting to the RS-485 bus, use a twisted pair cable, cat. 1 or higher.
...
**LIQUID INGRESS ON TERMINALS AND INTERNAL ELEMENTS OF THE DEVICE IS
UNACCEPTABLE.**
