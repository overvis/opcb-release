...
/*
curl -d '{}'  -H "Content-Type: application/json" http://localhost/api/confs/reset/
*/
async function openHandler(_req) {
    await this.bus.sendMsg(new opcb_ts_shared_1.redisBus.ResetConfig());
    return {};
}
exports.handler = (0, auth_1.auth)("writeConfs", openHandler);
//# sourceMappingURL=conf-reset.js.map