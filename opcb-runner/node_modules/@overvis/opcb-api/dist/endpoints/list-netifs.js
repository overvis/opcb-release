...
async function openHandler(_req) {
    await this.bus.sendRequest(new opcb_ts_shared_1.redisBus.UpdateList("netifs"));
    const netifs = await this.bus.getList("netifs");
    return netifs;
}
exports.handler = (0, auth_1.auth)("readConfs", openHandler);
//# sourceMappingURL=list-netifs.js.map