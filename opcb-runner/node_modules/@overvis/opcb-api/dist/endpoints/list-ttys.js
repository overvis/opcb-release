...
async function openHandler(_req) {
    await this.bus.sendRequest(new opcb_ts_shared_1.redisCmd.UpdateList("serials"));
    const serials = await this.bus.getList("serials");
    return serials;
}
exports.handler = (0, auth_1.auth)("readConfs", openHandler);
//# sourceMappingURL=list-ttys.js.map