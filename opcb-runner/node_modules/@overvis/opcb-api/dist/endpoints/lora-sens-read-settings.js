...
const BODY_SCHEMA = typebox_1.Type.Object({
    ...
    params: typebox_1.Type.Array(typebox_1.Type.Union([
        ...
        typebox_1.Type.Literal("systemTime"),
        typebox_1.Type.Literal("batteryVoltage"),
        typebox_1.Type.Literal("signalLevel"),
        typebox_1.Type.Literal("sensorWeightAdc1"),
        typebox_1.Type.Literal("sensorWeightAdc2"),
        typebox_1.Type.Literal("sensorWeightAdc3"),
        typebox_1.Type.Literal("sensorWeightAdc4"),
        typebox_1.Type.Literal("sensorWeightAdc5"),
        typebox_1.Type.Literal("sensorWeightAdc6"),
        typebox_1.Type.Literal("sensorWeightAdc7"),
        typebox_1.Type.Literal("sensorWeightAdc8"),
    ])),
});
const OK_RESPONSE_SCHEMA = typebox_1.Type.Partial(typebox_1.Type.Record(typebox_1.Type.KeyOf(typebox_1.Type.Object({
    ...
    systemTime: typebox_1.Type.String(),
    batteryVoltage: typebox_1.Type.String(),
    signalLevel: typebox_1.Type.String(),
    sensorWeightAdc1: typebox_1.Type.String(),
    sensorWeightAdc2: typebox_1.Type.String(),
    sensorWeightAdc3: typebox_1.Type.String(),
    sensorWeightAdc4: typebox_1.Type.String(),
    sensorWeightAdc5: typebox_1.Type.String(),
    sensorWeightAdc6: typebox_1.Type.String(),
    sensorWeightAdc7: typebox_1.Type.String(),
    sensorWeightAdc8: typebox_1.Type.String(),
})), typebox_1.Type.Object({
    value: typebox_1.Type.Optional(typebox_1.Type.Number()),
    lastValue: typebox_1.Type.Optional(typebox_1.Type.Number()),
