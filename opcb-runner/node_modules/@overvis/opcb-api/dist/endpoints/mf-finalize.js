...
/*
curl -d '{}'  -H "Content-Type: application/json" http://localhost/api/manufacture/finalize/
*/
async function openHandler(_req) {
    await this.bus.sendRequest(new opcb_ts_shared_1.redisBus.FinalizeManufacturing());
    return {};
}
exports.handler = (0, auth_1.auth)("writeConfs", openHandler);
//# sourceMappingURL=mf-finalize.js.map