...
async function registerOnMotherland(licenseUuid, licensePassword, wgPublicKey, macAddress, description) {
    ...
    return (0, motherland_1.motherlandRequest)("https://motherland.overvis.com/api/register-vpn-device/", { method: "POST", data }, exports.MOTHERLAND_REGISTRATION_INFO_SCHEMA);
}
