...
async function openHandler(req) {
    ...
    await (0, server_tools_1.timeout)(20000, this.bus.waitForMsg("dev-state"));
...
async function getDeviceIpFromMotherland(deviceWgPublicKey) {
    ...
    return await (0, motherland_1.motherlandRequest)("https://motherland.overvis.com/api/vpn-device-ip/", { method: "GET", params: { deviceWgPublicKey } }, MOTHERLAND_DEVICE_IP_SCHEMA);
}
exports.getDeviceIpFromMotherland = getDeviceIpFromMotherland;
async function getVpnDeviceInfo(motherlandVpnIp) {
    return await (0, motherland_1.motherlandRequest)(`http://${motherlandVpnIp}/api/vpn-device-info/`, { method: "GET" }, mf_register_1.MOTHERLAND_REGISTRATION_INFO_SCHEMA);
}
