...
const OK_RESPONSE_SCHEMA = typebox_1.Type.Object({
    ...
    ocpAccountEmail: typebox_1.Type.String(),
...
async function handler() {
    ...
    const confsData = await this.bus.getConfs([
        "overvisVpn:boundToOcpServer",
        "overvisVpn:boundToOcpAccountEmail",
    ]);
    return {
        ...
        modbusUid: data["virtualDevice:isEnabled"] && data["virtualDevice:uid"]
            ...
            : undefined,
        ocpServerName: confsData["overvisVpn:boundToOcpServer"] || "",
        ocpAccountEmail: confsData["overvisVpn:boundToOcpAccountEmail"] || "",
    };
}
