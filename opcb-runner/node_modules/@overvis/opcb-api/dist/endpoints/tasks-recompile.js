...
curl -s -S -d "{}" -H "Content-Type: application/json" \
    ...
    "http://localhost:4004/api/tasks/recompile/" | \
    jq -C
*/
...
async function openHandler() {
    const res = await this.bus.sendRequest(new opcb_ts_shared_1.redisCmd.RecompileTasks());
    if (res.error) {
...
//# sourceMappingURL=tasks-recompile.js.map