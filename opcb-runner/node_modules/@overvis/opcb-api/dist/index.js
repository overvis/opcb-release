...
async function run(setLogger, runConf) {
    ...
    // initializing bus
    const bus = new opcb_ts_shared_1.RedisBus(runConf.redisSocket, "API", exports.logger);
    const fastifyInstance = (0, fastify_1.default)({ logger: exports.logger.child({}) });
    ...
    const busPromise = bus.listenCmdStreamForever();
    return busPromise;
}
exports.run = run;
