...
exports.setDeviceActive = exports.deleteDevice = exports.saveDeviceSettings = exports.getBindedDevicesList = exports.LORA_DEVICE_SCHEMA = void 0;
const register_1 = require("./register");
const sku_1 = require("./sku");
const typebox_1 = require("@sinclair/typebox");
exports.LORA_DEVICE_SCHEMA = typebox_1.Type.Array(typebox_1.Type.Object({
...
function getBindedDevicesList(queries) {
    ...
    for (const loraDevice of loraDevices) {
        ...
        result.push({
            ...
            sku: loraDevice.sku,
            firmwareVersion: loraDevice.firmware_version,
            isConnected,
            isActive,
