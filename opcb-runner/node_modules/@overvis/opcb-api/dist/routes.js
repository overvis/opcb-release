...
const state = tslib_1.__importStar(require("./endpoints/state-get"));
...
function setRoutes(s) {
    ...
    s.get("/state/", { schema: state.SCHEMA }, state.handler);
    ...
    s.post("/manufacture/tests/check/", { schema: testsCheck.SCHEMA }, testsCheck.handler);
