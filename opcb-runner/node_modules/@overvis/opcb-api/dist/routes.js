...
const listSshAuthKeys = tslib_1.__importStar(require("./endpoints/list-ssh-authkeys"));
const setSshAuthKeys = tslib_1.__importStar(require("./endpoints/set-ssh-authkeys"));
...
const loraSensDevicesList = tslib_1.__importStar(require("./endpoints/lora-sens-get-list-devices"));
const loraSensUnbindedDevicesList = tslib_1.__importStar(require("./endpoints/lora-sens-get-list-unbinded-devices"));
const loraSensBind = tslib_1.__importStar(require("./endpoints/lora-sens-bind"));
const loraSensIgnore = tslib_1.__importStar(require("./endpoints/lora-sens-ignore"));
const loraSensDelete = tslib_1.__importStar(require("./endpoints/lora-sens-delete"));
const loraSensSaveSettings = tslib_1.__importStar(require("./endpoints/lora-sens-device-save-settings"));
const loraSensReadSettings = tslib_1.__importStar(require("./endpoints/lora-sens-read-settings"));
const loraSensWriteSettings = tslib_1.__importStar(require("./endpoints/lora-sens-write-settings"));
const loraSensGetReadings = tslib_1.__importStar(require("./endpoints/lora-sens-get-readings"));
const loraSensGetWeightModules = tslib_1.__importStar(require("./endpoints/lora-sens-get-weight-modules"));
const loraSensSetWeightModuleState = tslib_1.__importStar(require("./endpoints/lora-sens-set-weight-module-state"));
...
const startSdTest = tslib_1.__importStar(require("./endpoints/sd-test-start"));
function setRoutes(s) {
    ...
    s.get("/list/ssh-authkeys/", { schema: listSshAuthKeys.SCHEMA }, listSshAuthKeys.handler);
    s.post("/set-ssh-authkeys/", { schema: setSshAuthKeys.SCHEMA }, setSshAuthKeys.handler);
    ...
    s.get("/lora-sens/list/devices/", { schema: loraSensDevicesList.SCHEMA }, loraSensDevicesList.handler);
    s.get("/lora-sens/list/unbinded-devices/", { schema: loraSensUnbindedDevicesList.SCHEMA }, loraSensUnbindedDevicesList.handler);
    s.post("/lora-sens/device/bind/", { schema: loraSensBind.SCHEMA }, loraSensBind.handler);
    s.post("/lora-sens/device/ignore/", { schema: loraSensIgnore.SCHEMA }, loraSensIgnore.handler);
    s.post("/lora-sens/device/delete/", { schema: loraSensDelete.SCHEMA }, loraSensDelete.handler);
    s.post("/lora-sens/device/save-settings/", { schema: loraSensSaveSettings.SCHEMA }, loraSensSaveSettings.handler);
    s.post("/lora-sens/read-settings/", { schema: loraSensReadSettings.SCHEMA }, loraSensReadSettings.handler);
    s.post("/lora-sens/write-settings/", { schema: loraSensWriteSettings.SCHEMA }, loraSensWriteSettings.handler);
    s.get("/lora-sens/readings/", { schema: loraSensGetReadings.SCHEMA }, loraSensGetReadings.handler);
    s.get("/lora-sens/weight/modules/", { schema: loraSensGetWeightModules.SCHEMA }, loraSensGetWeightModules.handler);
    s.post("/lora-sens/weight/module/set-state/", { schema: loraSensSetWeightModuleState.SCHEMA }, loraSensSetWeightModuleState.handler);
    ...
    s.post("/sd-test/start/", { schema: startSdTest.SCHEMA }, startSdTest.handler);
