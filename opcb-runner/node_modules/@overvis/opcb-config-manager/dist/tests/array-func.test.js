...
describe("config manager", function () {
    it("should correctly set array parameters 1", async () => {
        ...
        expect((await bus.sendRequest(new opcb_ts_shared_1.redisBus.SetConfig({ "modbusRs485:0:baudRate": "4800" })))
            .status).toBe("ok");
    ...
    it("should correctly set array parameters 2", async () => {
        ...
        expect((await bus.sendRequest(new opcb_ts_shared_1.redisBus.SetConfig({ "modbusRs485:0:deviceName": "asdf" })))
            .status).toBe("ok");
    ...
    it("should clear array", async () => {
        ...
        expect((await bus.sendRequest(new opcb_ts_shared_1.redisBus.SetConfig({ "auth:users:*": null }))).status).toEqual("ok");
