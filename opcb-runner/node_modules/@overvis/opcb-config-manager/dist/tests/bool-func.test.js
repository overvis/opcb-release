...
describe("config manager", function () {
    it("should correctly set number parameters", async () => {
        ...
        expect((await bus.sendRequest(new opcb_ts_shared_1.redisCmd.SetConfig({ "global:setHostName": "true" })))
            .status).toBe("ok");
        ...
        // incorrect value
        expect((await bus.sendRequest(new opcb_ts_shared_1.redisCmd.SetConfig({ "global:setHostName": "0" }))).status).toEqual({
            code: opcb_ts_shared_1.redisCmd.ConfigValidationErrorCode.IncorrectValue,
            key: "global:setHostName",
        });
        expect((await bus.sendRequest(new opcb_ts_shared_1.redisCmd.SetConfig({ "global:setHostName": "False" })))
            .status).toEqual({
            code: opcb_ts_shared_1.redisCmd.ConfigValidationErrorCode.IncorrectValue,
            key: "global:setHostName",
        });
