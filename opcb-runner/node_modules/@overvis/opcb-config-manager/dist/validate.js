...
function changeConfig(config, changes) {
    ...
    for (const key in changesCopy) {
        ...
        if (!fieldSchema) {
            return new opcb_ts_shared_1.redisCmd.ConfigValidationResponse({
                code: opcb_ts_shared_1.redisCmd.ConfigValidationErrorCode.IncorrectKey,
                key,
            });
        }
    ...
    for (const key in changesCopy) {
        ...
        const requestedValue = changesCopy[key];
        let actualValue;
        let fieldType;
        let nullable = false;
        ...
        if (requestedValue === null) {
            ...
            //     if (array === undefined) {
            //         return new redisCmd.ConfigValidationResponse({
            //             code: redisCmd.ConfigValidationErrorCode.IncorrectKey,
            //             key,
            //         });
            //     }
            ...
            // } else {
            //     return new redisCmd.ConfigValidationResponse({
            //         code: redisCmd.ConfigValidationErrorCode.IncorrectValue,
            //         key,
            //     });
            // }
        }
    ...
    return new opcb_ts_shared_1.redisCmd.ConfigValidationResponse("ok");
}
