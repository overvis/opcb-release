...
exports.ensureFileOrDirectoryIsRemoved = exports.getFileContents = exports.ping = exports.ensureServiceState = exports.serviceIsActive = exports.ensureFileContainsString = exports.ensureFileContents = exports.exec = exports.ExecError = exports.execCmd = void 0;
...
async function ensureFileOrDirectoryIsRemoved(filename) {
    try {
        const stat = await fs.promises.stat(filename);
        _1.logger.warn(`${stat.isDirectory() ? "Directory" : "File"} exists, removing: ${filename}`);
        await fs.promises.rm(filename, { force: true, recursive: true });
    }
    catch (err) {
        if (err.code === "ENOENT") {
            return;
...
exports.ensureFileOrDirectoryIsRemoved = ensureFileOrDirectoryIsRemoved;
