...
async function run(setLogger, runConf) {
    ...
    bus.registerRequestHandler("sync-config", (0, sync_config_1.createSyncConfigHandler)({
        bus,
        bgworker,
        staticFilesDir: runConf.staticFilesDir,
        labelFile: runConf.labelFile,
        changelogFile: runConf.changelogFile,
    ...
    bus.registerRequestHandler("rerender-label", (0, rerender_label_1.createRerenderLabelHandler)(bus, runConf.staticFilesDir, runConf.labelFile));
    bus.registerRequestHandler("gen-pub-key", (0, gen_pub_key_1.createGenPubKeyHandler)());
    bus.registerRequestHandler("fin-mf", (0, fin_mf_1.createFinalizeManufacturingHandler)(runConf.manufacturerFile, bus));
