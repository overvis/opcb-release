...
async function checkForUpdates(state) {
    ...
    const updateMode = state.settings.updateMode;
    ...
    if (dirty && !state.settings.allowForcedUpdates) {
    ...
    await (0, exec_1.exec)("git fetch --prune --prune-tags --atomic --tags origin tag opcb/*");
