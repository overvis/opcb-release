...
async function ensureSystemState(config, monitor, bus, staticFilesDir) {
    ...
    (0, monitor_1.ensureMonitoring)(monitor, config.monitoring, config.elan.networkInterfaceName, config.wlan.networkInterfaceName, config.overvisVpn.wireguard.vpnMotherlandServerIp, wgServiceEnabled, config.global.manageNetworking, config.global.time.manageSettings, config.global.updateMode, config.global.autoUpdateTimeRange, config.global.allowForcedUpdates);
