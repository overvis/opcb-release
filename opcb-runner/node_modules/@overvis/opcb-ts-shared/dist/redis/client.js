...
var RedisClient = /** @class */ (function () {
    ...
    */
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        _loop_1 = function (message) {
                            ...
                            if (msg_2.REQID) {
                                var handler = this_1.responseHandlers.get(msg_2.REQID);
                                if (handler) {
                                    handler((0, deserialize_1.deserializeObjFromMsg)(msg_2));
                                    this_1.responseHandlers.delete(msg_2.REQID);
                                }
                            }
                            var handlers = this_1.awaitedCmds.get(msg_2.CMD);
                            if (handlers) {
                                ...
                                this_1.awaitedCmds.delete(msg_2.CMD);
                            }
                            var allHandlers = this_1.requestHandlers.get(msg_2.CMD);
                            if (!allHandlers) {
                                return "continue";
                            }
                            var msgDst = "DST" in msg_2 && msg_2.DST !== "any" ? msg_2.DST : undefined;
                            if (msgDst && !allHandlers.has(msgDst)) {
                                return "continue";
                            }
                            var obj = (0, deserialize_1.deserializeObjFromMsg)(msg_2);
                            var _loop_2 = function (dst, handler) {
                            ...
                            for (var _c = 0, _d = Array.from(allHandlers.entries()); _c < _d.length; _c++) {
                                var _e = _d[_c], dst = _e[0], handler = _e[1];
                                _loop_2(dst, handler);
                            }
                        };
                        this_1 = this;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, _reject) {
                                ...
                                _this.responseHandlers.set(msgId, function (resp) {
                                    resolve(resp);
                                });
                            })];
                }
    ...
    RedisClient.prototype.registerRequestHandler = function (dst, cmd, handler) {
        ...
        // }
        var allHandlers = this.requestHandlers.get(cmd);
        if (!allHandlers) {
            allHandlers = new Map();
            this.requestHandlers.set(cmd, allHandlers);
        }
        if (allHandlers.has(dst)) {
            throw new Error("Request handler for ".concat(cmd, " on dst ").concat(dst, " is already registered."));
        }
        allHandlers.set(dst, handler);
    };
    ...
    RedisClient.prototype.waitForMsg = function (cmdName) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, _reject) {
                        var cmds = _this.awaitedCmds.get(cmdName);
                        if (!cmds) {
                            cmds = [];
                            _this.awaitedCmds.set(cmdName, cmds);
                        }
    ...
    // TODO_FUTURE: rename to writeTransferLogStream
    ...
    RedisClient.prototype.writeGeneralLogStream = function (name, level, payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.redis.xadd(name, "*", "DATE", Date.now(), "LEVEL", level, "PAYLOAD", payload)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RedisClient.prototype.getActorClient = function (actor) {
        if (actor === "CFG") {
            ...
            return new actor_1.TskRedisClient(this, actor);
        }
        else if (actor === "TST") {
