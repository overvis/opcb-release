...
var LoraSensAdvertise = /** @class */ (function (_super) {
    ...
    LoraSensAdvertise.fromMsg = function (msg) {
        ...
        var timestampInt = parseInt(msg.TIMESTAMP.toString());
        if (Number.isNaN(timestampInt)) {
            throw new Error("TIMESTAMP field is NaN");
        }
        var timestamp = new Date(timestampInt * 1000);
        if (!msg.BAT) {
    ...
    LoraSensAdvertise.prototype.toMsg = function () {
        ...
        msg.DEVICE = Buffer.from(Math.floor(this.did).toString());
        return msg;
    };
