...
exports.RUNNER_CONFIG_SCHEMA = void 0;
var typebox_1 = require("@sinclair/typebox");
exports.RUNNER_CONFIG_SCHEMA = typebox_1.Type.Object({
    ...
    paths: typebox_1.Type.Object({
        ...
        opcbRs485TtyOperatorBin: typebox_1.Type.Optional(typebox_1.Type.String({ default: "./opcb-rs485-tty-operator" })),
        opcbModbusTcpClientBin: typebox_1.Type.Optional(typebox_1.Type.String({ default: "./opcb-modbus-tcp-client" })),
        opcbModbusTcpServerBin: typebox_1.Type.Optional(typebox_1.Type.String({ default: "./opcb-modbus-tcp-server" })),
        opcbOvervisRcClientBin: typebox_1.Type.Optional(typebox_1.Type.String({ default: "./opcb-overvis-rc-client" })),
        opcbLorasensGatewayBin: typebox_1.Type.Optional(typebox_1.Type.String({ default: "./opcb-lorasens-gateway" })),
        binCwd: typebox_1.Type.String({ default: "/opcb/bin" }),
        ...
        userTasksProjectDir: typebox_1.Type.String({ default: "../user/tasks" }),
        tasksProjectTemplateArchive: typebox_1.Type.String({ default: "../tasks-template.tar.gz" }),
