...
exports.STATE_SCHEMA = typebox_1.Type.Object({
    ...
    release: typebox_1.Type.Object({
        ...
        model: typebox_1.Type.Union([
            typebox_1.Type.Literal("opcb"),
            typebox_1.Type.Literal("opcb221"),
            typebox_1.Type.Literal("opcb221b"),
            typebox_1.Type.Literal("opcb224l"),
        ], {
            name: "OPCB model",
    ...
    loraSens: typebox_1.Type.Object({
        available: typebox_1.Type.Boolean({
            default: false,
            description: "Whether the LoRaSens gateway is available.",
        }),
        enabled: typebox_1.Type.Boolean({
            default: false,
            description: "Enable LoRaSens gateway.",
        }),
        frequencyDeviceKhz: typebox_1.Type.Integer({
            description: "Frequency device (kHz)",
            default: 868175,
        }),
        frequencyGatewayKhz: typebox_1.Type.Integer({
            description: "Frequency gateway (kHz)",
            default: 868100,
        }),
        ...
        spreadingFactor: typebox_1.Type.Integer({
            description: "Spreading factor",
            default: 7,
        }),
        codingRateBits: typebox_1.Type.Integer({
            description: "Coding rate bits",
            default: 5,
        }),
        txPowerLimitDbm: typebox_1.Type.Integer({
            description: "Tx power limit (dBm)",
            default: 17,
        }),
        loraPollingTimeMs: typebox_1.Type.Integer({
            description: "LoRa polling time (ms)",
            default: 500,
        }),
    }, {
        description: "LoraSens gateway status information",
        additionalProperties: false,
        default: {},
    }),
    tasks: typebox_1.Type.Object({
        totalTasksNum: typebox_1.Type.Integer({
            description: "Number of currently enabled tasks.",
        }),
        runningTasksNum: typebox_1.Type.Integer({
            description: "Number of currently running tasks.",
        }),
        failedTasksNum: typebox_1.Type.Integer({
            description: "Number of tasks stopped because of an error.",
        }),
        projectVersion: typebox_1.Type.Optional(typebox_1.Type.String({
            description: "The version of user tasks project (from package.json). Empty value means that project wasn't initialized.",
        })),
        lastCompilationOn: typebox_1.Type.Optional(typebox_1.Type.String({
            description: "Time of last compilation of user tasks, since current runtime boot.",
        })),
    }),
    sdTest: typebox_1.Type.Object({
        status: typebox_1.Type.Union([typebox_1.Type.Literal("ongoing"), typebox_1.Type.Literal("finished"), typebox_1.Type.Literal("failed")], {
            description: "The state of the last SD-card test run.",
        }),
        error: typebox_1.Type.Optional(typebox_1.Type.String({
            description: "The error message if the test failed.",
        })),
        startedOn: typebox_1.Type.Integer({
            description: "The time when the SD-card test was started. UNIX timestamp in UTC.",
        }),
        readSpeedMbps: typebox_1.Type.Number({
            description: "The read speed result of the test in Mb/s.",
        }),
        writeSpeedMbps: typebox_1.Type.Number({
            description: "The write speed result of the test in Mb/s.",
        }),
    }, {
        description: "The state and results of the last SD-card test run.",
        additionalProperties: false,
    }),
    gsm: typebox_1.Type.Object({
        dbusPath: typebox_1.Type.String(),
        "3gpp": typebox_1.Type.Object({
            imei: typebox_1.Type.String(),
            operatorCode: typebox_1.Type.String(),
            operatorName: typebox_1.Type.String(),
            packetServiceState: typebox_1.Type.String(),
            registrationState: typebox_1.Type.String(),
        }),
        generic: typebox_1.Type.Object({
            accessTechnologies: typebox_1.Type.String(),
            hardvareRevision: typebox_1.Type.String(),
            manufacturer: typebox_1.Type.String(),
            model: typebox_1.Type.String(),
            powerState: typebox_1.Type.String(),
            primaryPort: typebox_1.Type.String(),
            revision: typebox_1.Type.String(),
            signalQuality: typebox_1.Type.String(),
            state: typebox_1.Type.Union([typebox_1.Type.Literal("connected"), typebox_1.Type.Literal("registered")]),
            failedReason: typebox_1.Type.Optional(typebox_1.Type.String()),
        }),
        conn: typebox_1.Type.Object({
            device: typebox_1.Type.String(),
            iface: typebox_1.Type.String(),
            ipAddressCidr: typebox_1.Type.Optional(typebox_1.Type.String()),
            gateway: typebox_1.Type.Optional(typebox_1.Type.String()),
            dns1: typebox_1.Type.Optional(typebox_1.Type.String()),
            dns2: typebox_1.Type.Optional(typebox_1.Type.String()),
        }),
    }),
});
