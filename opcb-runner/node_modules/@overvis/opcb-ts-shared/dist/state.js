...
exports.STATE_SCHEMA = typebox_1.Type.Object({
    inet: typebox_1.Type.Object({
        ...
        ping: typebox_1.Type.Union([typebox_1.Type.Number(), typebox_1.Type.Literal("unreachable")], {
            ...
            mapper: new modbus_mappers_1.MAPPERS.U16WithLiteral(1004, "unreachable", 10),
    ...
    elan: typebox_1.Type.Object({
        ...
        gatewayPing: typebox_1.Type.Union([typebox_1.Type.Number(), typebox_1.Type.Literal("unreachable")], {
            name: "Gateway ping",
            mapper: new modbus_mappers_1.MAPPERS.U16WithLiteral(1049, "unreachable"),
    ...
    wlan: typebox_1.Type.Object({
        ...
        gatewayPing: typebox_1.Type.Union([typebox_1.Type.Number(), typebox_1.Type.Literal("unreachable")], {
            name: "Gateway ping",
            mapper: new modbus_mappers_1.MAPPERS.U16WithLiteral(1195, "unreachable", 10),
    ...
    wg: typebox_1.Type.Object({
        ...
        endpointAddress: typebox_1.Type.String({
            ...
            mapper: new modbus_mappers_1.MAPPERS.IPv4(1208),
        ...
        ping: typebox_1.Type.Union([typebox_1.Type.Number(), typebox_1.Type.Literal("unreachable")], {
            name: "Endpoint ping",
            mapper: new modbus_mappers_1.MAPPERS.U16WithLiteral(1212, "unreachable", 10),
    ...
    ram: typebox_1.Type.Object({
        used: typebox_1.Type.Integer({
            name: "Used memory",
            mapper: new modbus_mappers_1.MAPPERS.U32(1220),
            description: "The amount of memory used (bytes).",
            group: "General state",
            units: "bytes",
        }),
        total: typebox_1.Type.Integer({
            name: "Total memory",
            mapper: new modbus_mappers_1.MAPPERS.U32(1222),
            description: "The total amount of memory (bytes).",
            group: "General state",
            units: "bytes",
        }),
    }),
    sys: typebox_1.Type.Object({
        ...
        // cpus: Type.Array(
        //     Type.Object({
        //         model: Type.String({ description: "The CPU model." }),
        //         speed: Type.Integer({ description: "The CPU speed in MHz." }),
        //         times: Type.Object({
        //             user: Type.Integer({ description: "The number of CPU ticks in user mode." }),
        //             nice: Type.Integer({ description: "The number of CPU ticks in nice mode." }),
        //             sys: Type.Integer({ description: "The number of CPU ticks in sys mode." }),
        //             idle: Type.Integer({ description: "The number of CPU ticks in idle mode." }),
        //             irq: Type.Integer({ description: "The number of CPU ticks in irq mode." }),
        //         }),
        //     }),
        // ),
    ...
    storage: typebox_1.Type.Object({
        used: typebox_1.Type.Integer({
            ...
            mapper: new modbus_mappers_1.MAPPERS.U16(1224),
        ...
        total: typebox_1.Type.Integer({
            ...
            mapper: new modbus_mappers_1.MAPPERS.U32(1225),
    ...
    time: typebox_1.Type.Object({
        ...
        now: typebox_1.Type.Integer({
            name: "Local time",
            mapper: new modbus_mappers_1.MAPPERS.U32(1231),
        ...
        nowUtc: typebox_1.Type.Integer({
            name: "UTC time",
            mapper: new modbus_mappers_1.MAPPERS.U32(1233),
    ...
    release: typebox_1.Type.Object({
        ...
        lastUpgradeRef: typebox_1.Type.Optional(typebox_1.Type.String({
