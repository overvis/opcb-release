...
async function run(setLogger, runConf) {
    ...
    const loraSensModules = (await bus.getConfs(["loraSens:weightModules"]))["loraSens:weightModules"];
    const loraSenesRegisters = loraSensModules
        ? (0, parameter_1.createModbusLoraSensParameters)(loraSensModules)
        : [];
    ...
    bus.registerPartialRequestHandler("modbus-req", (0, handlers_1.createModbusRequestHandler)({
        ...
        configData,
        db,
    }, configMap, stateMap, virtParamsMap, loraSenesRegisters));
