...
describe("virtual device", function () {
    it("should correctly read ipv4 parameter", async () => {
        ...
        // IPv4 - id: 1319
        expect((await bus.sendRequest(new opcb_ts_shared_1.redisCmd.ModbusRequest((0, utils_1.makeReadRequest)(111, 1319, 1, 0x03), "rtu-no-crc"))).data.readUint16BE(3)).toBe(192);
        stop();
    });
    it("should correctly write single ipv4 parameter", async () => {
        ...
        // IPv4 - id: 1319
        await bus.sendMsg(new opcb_ts_shared_1.redisCmd.ModbusRequest((0, utils_1.makeWriteSingleRequest)(111, 1319, 195), "rtu-no-crc"));
        ...
        // incorrect value
        // IPv4 - id: 1319
        await bus.sendMsg(new opcb_ts_shared_1.redisCmd.ModbusRequest((0, utils_1.makeWriteSingleRequest)(111, 1319, 256), "rtu-no-crc"));
        expect(await bus.waitForNextMsg(await bus.getLastMsgId())).toMatchObject({
            cmd: "modbus-resp",
