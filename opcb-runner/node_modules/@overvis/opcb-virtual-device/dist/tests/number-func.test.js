...
describe("virtual device", function () {
    it("should correctly read number parameters", async () => {
        ...
        expect((await bus.sendRequest(new opcb_ts_shared_1.redisBus.ModbusRequest((0, utils_1.makeReadRequest)(111, 1783, 2, 0x04), "rtu-no-crc"))).data.readUInt32BE(3)).toBe(0);
        stop();
    });
