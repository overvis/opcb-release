...
exports.VIRTUAL_PARMAS_SCHEMA = typebox_1.Type.Object({
    deviceType: typebox_1.Type.Integer({
        ...
        regType: "holding",
        mapper: new opcb_ts_shared_1.MODBUS_MAPPERS.U16Literal(0, "42"),
    ...
    firmwareVersion: typebox_1.Type.Integer({
        ...
        mapper: new opcb_ts_shared_1.MODBUS_MAPPERS.U8(1),
    ...
    uniqueMacAddress: typebox_1.Type.String({
        ...
        regType: "holding",
        path: "overvisRc:mac",
        mapper: new opcb_ts_shared_1.MODBUS_MAPPERS.Mac(102),
    ...
    state: typebox_1.Type.Integer({
        ...
        regType: "holding",
        mapper: new opcb_ts_shared_1.MODBUS_MAPPERS.U16(108),
    ...
    activationCode: typebox_1.Type.Integer({
        ...
        mapper: new opcb_ts_shared_1.MODBUS_MAPPERS.U32(109),
