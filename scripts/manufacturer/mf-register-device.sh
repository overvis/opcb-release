...
# 7. Generate image Label
echo ""
echo "7. Generate device image..."
umask 0022
...
# 8. Save MAC to the file
echo ""
echo "8. Save MAC to the 'dev-bind-mac' file."
...
# 10. Save model to the file
echo ""
echo "10. Save model to the 'dev-model-name' file..."
umask 0077
echo "${labelName}" >"/opt/opcb-release/wireguard/dev-model-name"
echo "Pin code saved -- OK"
